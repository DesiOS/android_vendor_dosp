...
ALARM_PATH := vendor/dosp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dosp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dosp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/dosp/prebuilt/common/media/audio/ui
